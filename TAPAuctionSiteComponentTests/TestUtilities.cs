...
namespace TAP21_22.AuctionSite.Testing {
    internal static class Configuration {
        ...
        //MIEI 2018/19
        internal const string ImplementationAssembly = @"..\..\..\..\TAPAuctionSiteComponentLogic\bin\Debug\net5.0\TAPAuctionSiteComponentLogic.dll";

        internal const string ConnectionString = @"Data Source=.;Initial Catalog=PROGETTO_TAP_SIRI;Integrated Security=True;";
